...
-- 1) Создаем СТЕ cte_e_max, в котором группируем связи билетов с рейсами по id и классом обслуживания эконом, используем аггрегирующую функцию для нахождения максимальной цены
-- 1) Создаем СТЕ cte_b_min, в котором группируем связи билетов с рейсами по id и классом обслуживания бизнес, используем аггрегирующую функцию для нахождения минимальной цены
-- 2) Джойним СТЕ друг с другом по id перелета,
